...
from tartan_imu.utils.constants import DEFAULT_LOG_DIR, LOG_FORMAT, LOG_LEVEL
...
def console_log(message):
    """Log a message via the shared rich Console."""
    console.log(message)


def print_columns(data, title=None):
    """Print an iterable as rich columns, with an optional title."""
    if title:
        console.print(title)

...
# Add the repository root so top-level modules remain importable when this
# script is run directly from the example directory.
...
from tartan_imu.config.configer import load_config, build_model
...
def main():
    ...
    parser.add_argument('--config', type=str, 
                       default="./config/datasets/minimal_example/minimal_example_config.yaml",
